        ...
        <div className="flex-1 overflow-auto px-3 pb-4">
          <div className="max-w-md mx-auto">
            <div className="bg-blue-50 rounded-3xl p-3">
              ...
              <div className="bg-white rounded-xl p-3 mb-4 flex sm:flex-row sm:items-center gap-4">
                <div className="relative cursor-pointer group">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 rounded-full transition-all flex items-center justify-center">
                    <span className="text-white opacity-0 group-hover:opacity-100 text-xm font-medium">Change</span>
                  </div>
                </div>
                <p className="text-center sm:text-left text-gray-700 flex items-center">
            ...
            <button
              ...
              className="w-full bg-indigo-900 text-white rounded-xl py-4 font-medium flex items-center justify-center gap-2 mb-6 mt-6 top-4"
            >
              {isLoggingOut ? (
