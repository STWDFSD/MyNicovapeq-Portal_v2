...
export default function VerifyPage() {
  ...
  useEffect(() => {
    ...
    if (storedPhone) {
      ...
      // Redirect back to register if no phone number
  ...
  const handleVerify = async (verificationCode: string) => {
    if (!phoneNumber) {
      ...
      toast({
        ...
        description:
          "Phone number not found. Please return to the registration page and try again.",
        variant: "warning",
      });
      return;
    }
    ...
    try {
      ...
      if (response.success) {
        ...
        toast({
          ...
          description:
            "Your mobile number has been confirmed. Setting up your profile...",
          variant: "success",
        });
