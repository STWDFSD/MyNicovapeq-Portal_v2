    ...
    <div className="h-[100svh] flex flex-col overflow-hidden max-w-md mx-auto h-full">
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 pb-4 px-4">
          <div className="max-w-md mx-auto bg-[#F2F8FF] rounded-3xl p-6">
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-base font-medium text-black">Book a follow-up appointment</span>
                </div>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-base font-medium text-black">Manage your prescription</span>
                </div>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M5 12L19 12M19 12L12 5M19 12L12 19"
              ...
              <div className="bg-white rounded-2xl p-4 shadow-sm">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-black mb-1">Nicovape® Q50 50 mg/mL</h3>
                    <p className="text-lg font-semibold text-black mb-1">Classic Flavour 28</p>
                    <p className="text-sm text-gray-600">Supplies Remaining: 2</p>
                  </div>
                  <div className="ml-4">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-nIopThCrDH4ECDP7GOT2RZqvwM8DnV.png"
                      alt="QR Code"
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-base font-medium text-black">Find your nearest pharmacy</span>
                </div>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M5 12L19 12M19 12L12 5M19 12L12 19"
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-base font-medium text-black">Order home delivery</span>
                </div>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M5 12L19 12M19 12L12 5M19 12L12 19"
